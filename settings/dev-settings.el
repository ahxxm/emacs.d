...
;; ------------------------------------------------------------------
(dolist (p '("transient/lisp" "llama" "cond-let"
             "magit/lisp" "magit/lisp/magit-autoloads"
             "compat"           ;; required by with-editor
             "with-editor/lisp" "git-modes"))
  (add-to-list 'load-path (concat plugins-path-r p)))
