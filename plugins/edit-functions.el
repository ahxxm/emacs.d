;; -*- Emacs-Lisp -*-
;; Last modified: <2017-02-18 11:40:44 Saturday by richard>
...
(defun kill-line--before-until-cua-and-region-handled ()
  "If `mark-active', call `kill-region';
...
If At the string (which inside \") of the line and string is not empty, kill the string inside.."
  (interactive)
  (cond
   ((and cua-mode cua--rectangle) (call-interactively 'cua-cut-rectangle-as-text) t)
   (mark-active                   (call-interactively 'kill-region) t)
   ((or (bolp) (eolp))            (call-interactively 'kill-whole-line) t)
   (t                             nil)))
